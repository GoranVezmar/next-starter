...
export const ResetPasswordEmail = ({ username, resetUrl, userEmail, locale = "en" }: ResetPasswordEmailProps) => {
  // TODO translate this
  return (
        ...
        <Body className="bg-gray-100 py-[40px] font-sans">
          <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[40px] shadow-sm">
            ...
            <Section className="mb-[32px] rounded-[8px] bg-gray-50 p-[20px]">
              <Text className="m-0 mb-[8px] text-[14px] leading-[20px] font-semibold text-gray-700">Security Notice:</Text>
              <Text className="m-0 mb-[8px] text-[14px] leading-[20px] text-gray-600">
                • If you didn&apos;t request this password reset, please ignore this email
              </Text>
              <Text className="m-0 mb-[8px] text-[14px] leading-[20px] text-gray-600">• This link will expire in 24 hours</Text>
              <Text className="m-0 text-[14px] leading-[20px] text-gray-600">• For security, never share this link with anyone</Text>
            </Section>
            ...
            <Section className="border-t border-gray-200 pt-[24px]">
              <Text className="m-0 mb-[8px] text-[12px] leading-[16px] text-gray-500">This email was sent to {userEmail}</Text>
